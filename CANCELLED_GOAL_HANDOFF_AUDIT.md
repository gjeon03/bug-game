...
1. **"The sim survives a renderer change, so it survives this rebuild."** Rejected. Surviving a
   *renderer* change is not surviving a *dimension* change. Progression is `unlockOp: 1|2|3|4`
...
density *lesson* (one canvas stretched over 3700 mm is 3.6 mm/texel and reads as banned procedural
