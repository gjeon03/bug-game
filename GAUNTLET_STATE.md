...
| B0  | **A complete run is proven for the concealment build.** `shadow`, seed 4242, bathroom skipped: **WON in 13.6 min**, gates kitchen→hallway 1.0 / living 8.0 / bedroom 8.8, 9 footholds claimed across four regions, peak population 43, 15 sightings, 34 workers lost, **1 extermination sweep survived**, longest plateau 6.2 s. The `brood` build is still tuning — see B6.                                                                                                                                                                                                                                                                                 | **PARTIAL**                  |
...
| B6  | **The `brood` build starves itself.** Seed 20260805: capacity 30, 199 deliveries, every region at alert 0 and no sweeps — yet the run ends moisture 0, population 0. It is not the household; the specialization that exists to grow the colony outgrows its own water supply. `BROOD_MOISTURE_PER_WORKER` cut 4.2 → 2.4 (eggs want protein more than water, and asymmetric costs also keep brood distinct from scavenging). Re-measuring.                                                                                                                                                                                                                   | **OPEN — in progress**       |
