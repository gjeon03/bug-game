...
const SPECS: Readonly<Record<MaterialId, Spec>> = {
  ...
  floorWood: {
    ...
    roughness: 0.52,
    metalness: 0.02,
    wear: { streaks: 1500, blotches: 70, scuffs: 70, grain: 'horizontal', seed: 41, normalScale: 0.55 },
  },
  floorVinyl: {
    colour: 0x8d8578,
    roughness: 0.56,
    metalness: 0.02,
    wear: { streaks: 1100, blotches: 60, scuffs: 90, grain: 'horizontal', seed: 43, normalScale: 0.5 },
  },
  skirting: {
    colour: 0xcfc7bb,
    roughness: 0.55,
